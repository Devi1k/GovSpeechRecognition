...
parser.add_argument('--use_tensorrt', type=eval, default=False, choices=[True, False],
...
parser.add_argument('--enable_mkldnn', type=eval, default=False, choices=[True, False],
